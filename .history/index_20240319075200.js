...
app.post('/api/foods', foodsUpload.single('item-img'), async(req, res) => {
    ...
    console.log('form data', formData, path.extname(req.file.originalname));

    var tmp_path = req.file.path;
    var image_name = Date.now() + '_' + Math.random().toString(36).substring(7) + '.' + mime.extension(req.file.mimetype);
    var target_path = './public/uploads/foods/' + image_name;
