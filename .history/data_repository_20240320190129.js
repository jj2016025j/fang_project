    ...
    getReport: ()=> {
        return new Promise((resolve, reject) => {
            pool.getConnection((err, connection) => {
                ...
                var monthTurnoverOfYearSql = `SELECT YEAR(payment_at) as year, MONTH(payment_at) as month, SUM(trade_amt) as price FROM table_orders WHERE  order_status = 2 GROUP BY YEAR(payment_at), MONTH(payment_at)`;
