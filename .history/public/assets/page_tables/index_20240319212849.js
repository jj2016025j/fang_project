        ...
        return `
            <div class="seat-layout">
                ...
                <div class="seat-option-content">
                    ${search ? `
                        1<a target="_blank" href="${qrcodeUrl}" data-seatnum=${seatNum} class="seat-qrcode-btn"><div id="qrcode_${search.trade_no}" class="qr-img"></div></a>
                        ` : `
                        2<a data-seatnum=${seatNum} class="seat-order-btn" href="/shop/tableOrder">點餐/結帳</a>
                        3<a data-seatnum=${seatNum} class="generate-table-order-btn">生成QR code</a>
                    `}
                </div>
            </div>
        `
