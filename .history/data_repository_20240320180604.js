    ...
    getReport: ()=> {
        return new Promise((resolve, reject) => {
            pool.getConnection((err, connection) => {
                ...
                var rankTop5Sql = `SELECT food_id, SUM(quantity) as total FROM orders_items oi LEFT JOIN table_orders o ON o.id = oi.order_id WHERE o.order_status = 2 GROUP BY food_id ORDER BY total DESC LIMIT 5`;
                ...
                connection.query('SELECT * FROM table_orders', (error, results) => {
                    connection.release();
                    if (error) {
                        reject(error);
                        return;
